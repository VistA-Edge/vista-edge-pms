...
public class UnpostedRep {

  public int generateUnpost(String fromDate,String toDate) throws SQLException{
        Connection con;
        DBConnection DB=new DBConnection();
        con=DB.getPMSConnection();
    try{
           JasperDesign jasperDesign = JRXmlLoader.load("javaReport/unposted/unposted.jrxml");
           JasperReport jasperReport = JasperCompileManager.compileReport(jasperDesign);

           Map model = new HashMap();

           model.put("frmDate",fromDate);
