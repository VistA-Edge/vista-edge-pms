...
public class ReceiptMethods {
  ...
  public int generateReceipt(String fromDate,String toDate) throws SQLException{
        Connection con;
        DBConnection DB=new DBConnection();
        con=DB.getPMSConnection();
    try{
           JasperDesign jasperDesign = JRXmlLoader.load("javaReport/receipt/receipt.jrxml");
